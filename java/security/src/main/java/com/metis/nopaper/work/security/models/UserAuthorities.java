...
@Setter
@NoArgsConstructor
@Table(name = "user_authorities", schema = "nopaperwork", uniqueConstraints = { @UniqueConstraint(columnNames = "name") })

public class UserAuthorities extends AbstractAuditEntity {
	/**
	 *
	 */
